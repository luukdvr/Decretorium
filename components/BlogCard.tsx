  ...
  return (
    <article className="card overflow-hidden">
      <div className="p-4 md:p-6">
        ...
        <Link href={blog.category === 'juridisch' ? `/juridisch/blogs/${blog.slug}` : `/blogs/${blog.slug}`} className="btn w-full sm:w-auto inline-block text-center" aria-label={`Lees blog: ${blog.title}`}>Lees blog</Link>
      </div>
    </article>
  )
}
