    ...
    <>
      ...
      <section className="section">
        <div className="container">
          <p className="max-w-3xl text-gray-700 leading-relaxed mb-6 md:mb-8 text-sm md:text-base">
      ...
      <section className="section bg-gray-50">
        <div className="container">
          <div className="card p-4 md:p-6 lg:p-8">
            ...
            <ul className="list-disc pl-5 text-gray-800 space-y-1 text-sm md:text-base">
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="mt-6 md:mt-8 card p-6 md:p-8 flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            <p className="text-gray-700 text-sm md:text-base">Meer weten over ons MVO-beleid of samenwerken aan een initiatief? Neem contact op.</p>
