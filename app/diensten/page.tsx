  ...
  return (
    <section className="section">
      <div className="container">
        <h1 className="mb-4 md:mb-6 text-white">Diensten</h1>
        <div className="mb-8 md:mb-10">
          <h2 className="mb-2 text-white">Beveiliging</h2>
          <p className="mb-4 md:mb-6 text-white text-sm md:text-base">Overzicht van onze beveiligingsdiensten.</p>
        ...
        <div className="mt-8 md:mt-12">
          <h2 className="mb-2 text-white">Juridisch</h2>
          <p className="text-white max-w-3xl text-sm md:text-base">
